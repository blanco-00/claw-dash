...
- [x] 9.1 配置 ESLint + Prettier
- [x] 9.2 配置 .editorconfig
- [x] 9.3 封装统一 request 拦截器 (Token/错误处理)
- [x] 9.4 封装统一 API 响应类型
- [ ] 9.5 创建通用组件 (Table/Form/Modal/Filter)
- [ ] 9.6 配置路径别名 (@/ 等)

## 10. 后端编码规范

- [ ] 10.1 配置 Checkstyle 插件
...
- [ ] 10.1 性能优化 (缓存、索引)
- [ ] 10.2 安全加固 (HTTPS, CORS, Rate Limit)
- [ ] 10.3 日志完善
- [ ] 10.4 错误处理统一
- [ ] 10.5 API 文档生成 (Swagger)
