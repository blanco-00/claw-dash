...
-- ============================================================================
-- Seed Data: Agent Connections (Sample Topology)
-- ============================================================================
INSERT INTO config_graph_edges (graph_id, source_id, target_id, edge_type, enabled, decision_mode, message_template, source_handle, target_handle) VALUES
(1, 'main', 'menxiasheng', 'task', 1, 'always', NULL, 'bottom', 'top'),
(1, 'main', 'shangshiju', 'task', 1, 'always', '触发条件：饮食安排、起居照料、服饰搭配、生活琐事\n【尚食局】\n主人吩咐：\n{original_message}\n照料好主人的日常起居哦～', 'left', 'top'),
(1, 'main', 'jinyiwei', 'task', 1, 'always', '触发条件：简单查询，信息收集 / 跑腿、传话 / 一次性执行任务 / 用户明确说"快一点" \n【急件】锦衣卫亲启：\n{original_message}\n执行后直接回报结果。', 'left', 'top'),
(1, 'main', 'shangyaosi', 'task', 1, 'always', '触发条件：健康咨询、医疗保健、养生调理、身体状况\n【尚药司】\n主人吩咐：\n{original_message}\n允贤会细心照料主人的健康哦～', 'left', 'top'),
(1, 'menxiasheng', 'shangshusheng', 'task', 1, 'always', '触发条件：审核通过、需要分发给六部执行、任务已决策\n【门下省】\n卿酒已审核完毕，请红袖姐姐分发执行：\n{original_message}\n执行要点：\n- 分配给对应部门\n- 监督执行', 'bottom', 'top'),
(1, 'shangshusheng', 'gongbu', 'task', 1, 'always', '触发条件：技术任务、工程开发、工具制作、系统维护\n【工部】\n红袖姐姐分发任务：\n{original_message}\n执行后回报结果～', 'bottom', 'top'),
(1, 'shangshusheng', 'libu4', 'task', 1, 'always', '触发条件：人事调配、人员考核、人才培养、人才发掘\n【吏部】\n红袖姐姐分发任务：\n{original_message}\n珊瑚姐姐安排一下哦～', 'bottom', 'top'),
(1, 'shangshusheng', 'hubu', 'task', 1, 'always', '触发条件：财务预算、支出审核、资产配置、费用审批\n【户部】\n红袖姐姐分发任务：\n{original_message}\n琉璃姐姐帮忙把关一下财务哦～', 'bottom', 'top'),
(1, 'shangshusheng', 'xingbu', 'task', 1, 'always', '触发条件：法务审核、规则制定、合同审查、违规处理\n【刑部】\n红袖姐姐分发任务：\n{original_message}\n如意姐姐帮忙把关一下哦～', 'bottom', 'top'),
(1, 'shangshusheng', 'bingbu', 'task', 1, 'always', '触发条件：安全保障、风险预警、安全审查、威胁评估\n【兵部】\n红袖姐姐分发任务：\n{original_message}\n魅羽姐姐帮忙评估一下安全风险哦～', 'bottom', 'top'),
(1, 'shangshusheng', 'libu3', 'task', 1, 'always', '触发条件：外交事务、文化推广、新闻推送、知识分享\n【礼部】\n红袖姐姐分发任务：\n{original_message}\n书瑶姐姐安排一下哦～', 'bottom', 'top');
